...
const styles = createThemedStyles((colors) => ({ muted: { ...typography.caption, color: colors.textMuted }, summary: { ...typography.body, color: colors.text, fontWeight: "700" }, row: { flexDirection: "row" }, symbol: { width: 56, padding: spacing.xs, ...typography.label, color: colors.primary }, cell: { width: 64, padding: spacing.xs, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border }, cellText: { ...typography.caption, color: colors.text, textAlign: "center" } }));
