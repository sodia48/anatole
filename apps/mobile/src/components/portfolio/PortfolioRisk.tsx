...
const styles = StyleSheet.create({ grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, metric: { width: "47%", gap: 2 }, label: { ...typography.caption, color: colors.textMuted }, value: { ...typography.body, color: colors.text, fontWeight: "800" }, reading: { ...typography.body, color: colors.textMuted } });
