...
const styles = createThemedStyles((colors) => ({ coverage: { ...typography.caption, color: colors.primary, fontWeight: "800" }, grid: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, metric: { width: "47%", gap: 2 }, label: { ...typography.caption, color: colors.textMuted }, value: { ...typography.body, color: colors.text, fontWeight: "800" }, reading: { ...typography.body, color: colors.textMuted } }));
