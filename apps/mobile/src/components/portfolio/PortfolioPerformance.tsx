...
const styles = createThemedStyles((colors) => ({ note: { ...typography.caption, color: colors.textMuted }, row: { flexDirection: "row", flexWrap: "wrap", gap: spacing.sm }, metric: { minWidth: 96, flexGrow: 1, padding: spacing.sm, borderWidth: 1, borderColor: colors.border, borderRadius: 10 }, label: { ...typography.label, color: colors.primary }, value: { ...typography.section, color: colors.text }, coverage: { ...typography.caption, color: colors.textSubtle } }));
