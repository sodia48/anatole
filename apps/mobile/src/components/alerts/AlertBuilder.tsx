...
const styles = createThemedStyles((colors) => ({ wrap: { flexDirection: "row", flexWrap: "wrap", gap: spacing.xs }, row: { flexDirection: "row", gap: spacing.xs }, chip: { minHeight: 44, justifyContent: "center", paddingHorizontal: spacing.sm, borderWidth: 1, borderColor: colors.border, borderRadius: radius.sm }, active: { borderColor: colors.primary, backgroundColor: "rgba(44,156,255,.2)" }, text: { ...typography.caption, color: colors.text } }));
