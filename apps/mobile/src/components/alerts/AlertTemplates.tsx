...
const styles = createThemedStyles((colors) => ({ note: { ...typography.caption, color: colors.textMuted }, wrap: { gap: spacing.xs }, chip: { minHeight: 44, justifyContent: "center", paddingHorizontal: spacing.md, borderWidth: 1, borderColor: colors.borderStrong, borderRadius: radius.sm }, text: { ...typography.label, color: colors.primary } }));
