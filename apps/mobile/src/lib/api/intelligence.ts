...
export const intelligenceApi = {
  ...
  compare: (symbols: string[], range: ComparisonRange, signal?: AbortSignal) => apiRequest<ComparisonSnapshot>("/api/v1/analysis/compare", { method: "POST", body: JSON.stringify({ symbols, range }), timeoutMs: 90_000, signal }),
};
