...
export type NewsItem = { id: string; title: string; summary: string; url: string; source?: string; publisher?: string; category?: string; regions?: string[]; published_at: string };
export type NewsSnapshot = { items: NewsItem[]; generated_at: string; refresh_after_seconds?: number };
...
export type EarningsItem = { ticker: string; symbol: string; company: string; sector: string | null; starts_at: string; window_start: string; window_end: string; time_is_estimated: boolean; eps_estimate: number | null; revenue_estimate: number | null; estimate_currency: string | null; source?: string; url?: string };
export type EarningsSnapshot = { events: EarningsItem[]; companies_with_dates: number; generated_at: string; refresh_after_seconds?: number };
export type CalendarEvent = { id: string; title: string; starts_at: string; importance: string; category: string; country: string; regions?: string[]; source?: string; url?: string | null; description?: string | null };
export type CalendarSnapshot = { events: CalendarEvent[]; generated_at: string; refresh_after_seconds?: number };
