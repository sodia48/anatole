...
export function AppProviders({ children }: PropsWithChildren) {
  ...
  return (
    <PersistQueryClientProvider client={queryClient} persistOptions={{
      ...
      dehydrateOptions: {
        shouldDehydrateQuery: (query) => ["cockpit", "screener", "terminal", "focus", "news", "earnings", "calendar", "stock-news", "etf-directory", "etf-holdings", "etf-history", "ipo", "insiders"].includes(String(query.queryKey[0])),
      },
    }}>
      <LocaleProvider>
