...
export default function GlobalSearchScreen() {
  const { pick } = useLocale(); const [query, setQuery] = useState(""); const [recent, setRecent] = useState<string[]>([]); const command = parseSearchCommand(query);
