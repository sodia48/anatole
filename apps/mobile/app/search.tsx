...
import { navigateSearchCommand, parseSearchCommand } from "@/src/components/search/commandParser";
...
export default function GlobalSearchScreen() {
  ...
  const runCommand = () => { if (!command) return; void remember(query); navigateSearchCommand(command, (href) => router.push(href as never)); };
