...
const styles = createThemedStyles((colors) => ({ muted: { ...typography.body, color: colors.textMuted }, addRow: { flexDirection: "row", alignItems: "flex-end", gap: spacing.sm }, addButton: { minWidth: 96, paddingBottom: 1 }, empty: { ...typography.body, color: colors.textMuted, textAlign: "center", padding: spacing.xl }, item: { flexDirection: "row", alignItems: "center" }, remove: { color: colors.negative, fontSize: 26, paddingHorizontal: spacing.sm } }));
