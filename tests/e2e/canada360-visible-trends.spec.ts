...
const history = [
  { period: "2020", value: 90 },
  { period: "2021", value: 94 },
  { period: "2022", value: 98 },
  { period: "2023", value: 101 },
  { period: "2024", value: 104 },
];
...
test("Canada 360 comparator visibly shows cadence and mini histories", async ({ page }) => {
  ...
  await expect(qc.getByRole("img")).toBeVisible();
  await expect(qc).toContainText(/Annuel|Annual/);
